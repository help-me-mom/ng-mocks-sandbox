...
export class BaseDirective {
  ...
  @ContentChildren(DivDirective) public contentChildrenBase?: QueryList<DivDirective>;
...
export class OverrideComponent extends BaseDirective {
  @ContentChild(DivDirective) public contentChildOverride?: DivDirective;
  @ContentChildren(DivDirective) public contentChildrenOverride?: QueryList<DivDirective>;
